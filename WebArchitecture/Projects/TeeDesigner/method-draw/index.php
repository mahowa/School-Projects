...
<!--  <script type="text/javascript" src="lib/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>-->
  ...
  <script type="text/javascript" src="LayersExtension.js"></script>

  <script type="text/javascript" src="imagetracer_v1.1.0.js"></script>
  <script type="text/javascript" src="ImageToSVG.js"></script>
  ...
  <script>
    ...
    $(document).ready(function(){
      $("#use_this").click(function(){
        custom_svg = svgCanvas.getSvgString();
...
<!--Script by Charlie Barber  -->
  <script>
    $(function() {
      ...
      $( "#shortCutsButton" ).click(function() {
...
<body>
<div id="shortCutDialog" title="Shortcuts">
  <table>
    <thead><th>Action</th><th>Shortcut</th></thead>
    <tbody>
    <tr><td>New Document</td><td>ctrl+n</td></tr>
    <tr><td>Open SVG</td><td>ctrl+o</td></tr>
    <tr><td>Import Image</td><td>ctrl+i</td></tr>
    <tr><td>Export as PNG</td><td>ctrl+e</td></tr>
    <tr><td>Select Tool</td><td>ctrl+s</td></tr>
    <tr><td>Pencil Tool</td><td>ctrl+p</td></tr>
    <tr><td>Line Tool</td><td>ctrl+l</td></tr>
    <tr><td>Rectangle Tool</td><td>ctrl+r</td></tr>
    <tr><td>Elipse Tool</td><td>e</td></tr>
    <tr><td>Path Tool</td><td>ctrl+a</td></tr>
    <tr><td>Shapes Tool</td><td>ctrl+h</td></tr>
    <tr><td>Text Tool</td><td>x</td></tr>
    <tr><td>Zoom Tool</td><td>z</td></tr>
    <tr><td>Eye Dropper Tool</td><td>i</td></tr>
    <tr><td>Use Design</td><td>u</td></tr>
    </tbody>
  </table>
</div>

<form id="keep" method="post" action="../index.php">
...
<div id="tools_top" class="tools_panel">
  <button id="shortCutsButton" style="margin-top: 25px">Shortcuts</button>
  ...
  <table id="layersPanel" style="width: 100%; border-radius: 5px">
    <thead>
    <tr style="background-color: #0b0b0b; color: white"><th><strong>Layers</strong></th></tr>
    </thead>
    <tbody id="LayerList" style="max-height: 200px; overflow: auto">

    </tbody>
    <tfoot>
    <tr style="margin-left: auto; margin-right: auto; background-color: #0b0b0b;">
      <td>
        <img src="images/LayerIcon/Page%20Overview%20-50.png" height="25" width="25" style="cursor: pointer" onclick="newLayer()"/>
        <img src="images/LayerIcon/Copy-50.png" height="25" width="25" style="cursor: pointer" onclick="duplicateLayer()"/>
        <img src="images/LayerIcon/Merge%20Files-52.png" height="25" width="25" style="cursor: pointer" onclick="mergeLayers()"/>
        <img src="images/LayerIcon/Trash%20Filled-50.png" height="25" width="25" style="cursor: pointer" onclick="deleteLayer()"/>
      </td>
    </tr>
    </tfoot>
  </table>
  <p id="selectedLayer"></p>
...
<ul id="cmenu_canvas" class="contextMenu">
  ...
  <li><a href="#img_trace" onclick="traceImage()">Trace Image</a></li>
</ul>

<div id="newLayer_dialog" >
  <input type="text" placeholder="Layer Name" id="layerName" required>
</div>
