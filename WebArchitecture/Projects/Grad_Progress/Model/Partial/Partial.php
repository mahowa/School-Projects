    ...
    public function __construct($page)
    {
        ...
        switch($page){
            ...
            case "dForm":
                ...
                $this->CSS .="<link rel='stylesheet' href='../../Style/styles.css' type='text/css'/>";
                break;
...
//                $this->CSS .="<link rel='stylesheet' href='../../Style/form.css' type='text/css'/>";
    ...
    public function head($title){
        return  "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.1//EN\" \"http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd\">
                ...
                <head>
                    ...
                    <title>$title</title>
                    <link rel='stylesheet' href='../../Style/required.css' type='text/css'/>
    ...
    private function navlink_setup(){
        ...
        $project ="<li class='dropdown'>
                        ...
                        <ul class='dropdown-menu'>
                            <li><a href='../../Controller/Main/main.php'>Graduate Student Due Process Form</a></li>
    ...
    public function login_registerHtml(){

        //Not Signed in
        if(!isset($_SESSION["UserName"])) {
            $return = "<form method='post' action='../SignIn/SignIn.php' class='navbar-form navbar-left' role='search'>
                          <div class='form-group'>
                            <input type='text' class='form-control' name='uname' placeholder='Username' required>
                            <input type='password' class='form-control' name='pass' placeholder='Password'  required>
                          </div>
                          <button type='submit' class='btn btn-secondary-outline'>login</button>
                          <a class='btn btn-link' href='../NewUser/NewUser.php'>Register</a>
                       </form>";
        }
        //Signed in
        else{
            //Set Profile page for DGS
            if($_SESSION["Role"]==2) {

                $return = "
                <li><a class='btn btn-link' href='../../Controller/Main/main.php'>Hi, " . $_SESSION['FirstName'] . " " . $_SESSION['LastName'] . "!</a></li>
                <li><a class='btn btn-link' href='../../Controller/SignIn/SignIn.php?logout=1'>Logout</a></li>
                ";
            }
            //Set Profile page for Faculty
            else if($_SESSION["Role"]==1){
                $return = "
                <li><a class='btn btn-link' href='../../Controller/Advisor/students.php?id=".$_SESSION['RoleId']."'>Hi, " . $_SESSION['FirstName'] . " " . $_SESSION['LastName'] . "!</a></li>
                <li><a class='btn btn-link' href='../../Controller/SignIn/SignIn.php?logout=1'>Logout</a></li>
                ";
            }
            //Set Profile page for Student
            else{

                $return = "
                <li><a class='btn btn-link' href='../../Controller/Student/student_forms.php?id=".$_SESSION['RoleId']."'>Hi, " . $_SESSION['FirstName'] . " " . $_SESSION['LastName'] . "!</a></li>
                <li><a class='btn btn-link' href='../../Controller/SignIn/SignIn.php?logout=1'>Logout</a></li>
                ";
            }
        }
